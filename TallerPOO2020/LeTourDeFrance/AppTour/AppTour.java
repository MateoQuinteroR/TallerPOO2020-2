package TallerPOO2020.LeTourDeFrance.AppTour;

import TallerPOO2020.LeTourDeFrance.Corredor;
import TallerPOO2020.LeTourDeFrance.Equipo;
import TallerPOO2020.LeTourDeFrance.Tour;
...
public class AppTour {
    ...
    public static void main(String[] args) {
        ...
        Corredor MarkKavendish = new Corredor("Mark Kavendish",(byte) 21,(byte) 29,"Gran Bretaña");
        ...
        Arkea.getCorredores().add(CadelEvans );
        ...
        Astana.getCorredores().add(MarkKavendish);
        ...
        Movistar.getCorredores().add(MarkCavendish );
        ...
        ArrayList<Equipo> Equipos = new ArrayList<Equipo>(Arrays.asList(Ineos,Arkea,Astana,Movistar,UAE));
